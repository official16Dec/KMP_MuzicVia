...
@NonNullApi
public class MuzicViaProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MuzicViaProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
